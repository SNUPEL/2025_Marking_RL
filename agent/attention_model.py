...
class AttentionModel(nn.Module):
    ...
    def __init__(self,
        ...
        if self.problem.NAME == "tsp":
            ...
            assert problem.NAME == "nesting", "Unsupported problem: {}".format(problem.NAME)
    ...
    def _get_parallel_step_context(self, embeddings, state, from_start=False):
        """
        ...
        if self.problem.NAME == "tsp":
            ...
            if from_start:
                ...
                return torch.gather(embeddings,1, current_node.contiguous().view(batch_size, num_steps, 1)
